...
const ImageLinkForm = ({onInputChange, onPictureSubmit, onClearSubmit}) => {
	return(
		<div>
			<p className='f3'>
            ...
            <div className='backgroundpattern pa4 br3 shadow-5 center' style={{width:'900px'}}>
               <input className='f4 pa2 w-60' type='text' placeholder='Please paste a jpg link of your picture:' onChange={onInputChange}/>
               <button 
